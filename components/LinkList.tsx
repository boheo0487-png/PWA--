            ...
            <tr key={link.id} className="hover:bg-slate-50/30 transition-all group">
              <td className="px-10 py-8">
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-slate-900 tracking-tight text-base">{link.short}</span>
                    <button className="p-1.5 opacity-0 group-hover:opacity-100 hover:bg-slate-100 rounded-lg transition-all text-slate-400 hover:text-indigo-600">
              ...
              <td className="px-10 py-8">
                <div className="flex flex-col gap-1 max-w-[300px]">
                  <p className="truncate text-sm text-slate-500 font-medium">{link.original}</p>
              ...
              <td className="px-10 py-8">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-base font-extrabold text-slate-700 tracking-tight">{link.clicks}</span>
                </div>
              </td>
              <td className="px-10 py-8">
                <div className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full ${
                  link.status === 'Live' ? 'bg-emerald-50 text-emerald-600' : 'bg-slate-100 text-slate-400'
                }`}>
              ...
              <td className="px-10 py-8 text-right">
                <div className="flex items-center justify-end gap-3">
                  <button className="w-10 h-10 flex items-center justify-center hover:bg-slate-50 rounded-xl text-slate-400 hover:text-slate-900 transition-all">
